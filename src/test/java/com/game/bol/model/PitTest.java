...
public class PitTest {
    ...
    public void shouldDistributable(){
        ...
        //then
        Assert.assertEquals(true, pit1.isDistributable(Status.PLAYER1_TURN));
        Assert.assertEquals(false, pit7.isDistributable(Status.PLAYER2_TURN));
    }
    ...
    public void shouldPlayerPit(){
        ...
        //then
        Assert.assertEquals(true, pit1.isPlayerPit(Status.PLAYER1_TURN));
        Assert.assertEquals(false, pit1.isPlayerPit(Status.PLAYER2_TURN));
    }

    @Test
    public void shoudTestHouse(){
        //given
        Pit pit1 = new Pit(1, 6, 1);
        Pit pit7 = new Pit(7, 6, 1);
    ...
    @Test
    public void shouldTestPlayer1House(){
    ...
    @Test
    public void shouldTestPlayer2House(){
